  ...
  mcp.tool(
    ...
    'Search Axelar GMP events. Filter by sourceAddress, destinationChain, and destination contract address.',
    {
      size: z.coerce
        ...
        .max(100)
        .optional()
        .describe('Max results to return (default per upstream or 1).'),
      sourceAddress: z
        .string()
        .optional()
        .describe('Source chain caller address (e.g., agoric1... or 0x...).'),
      address: z
        .string()
        .optional()
        .describe(
          'Destination chain contract address (e.g., factory contract).',
        ),
      destinationChain: z
        .string()
        .optional()
        .describe('Destination chain (e.g., avalanche | arbitrum | ethereum).'),
    },
